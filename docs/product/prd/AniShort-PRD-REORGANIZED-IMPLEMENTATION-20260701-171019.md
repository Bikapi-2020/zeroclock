...
本文档是 PRD 的重整理实施版，不是“原文 + 附录”的堆叠版。整理原则如下：
...
### Academy AV 补强：个人版、团队版、协作、积分与存储
...
### Academy AV 补强：对齐字段、证据映射与后续合并规则
